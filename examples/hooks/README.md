...
The interface hooks use generic methods on `tego.InterfaceHooks` to add hooks that validate Tego
requests implementing `Validate() error` and finalize Tego responses implementing
