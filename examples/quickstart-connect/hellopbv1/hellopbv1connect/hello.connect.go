...
type GreeterServiceClient interface {
	SayHello(context.Context, *connect.Request[hellopbv1.SayHelloRequest]) (*connect.Response[hellopbv1.SayHelloResponse], error)
}
...
func NewGreeterServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreeterServiceClient {
	...
	greeterServiceMethods := hellopbv1.File_proto_hello_v1_hello_proto.Services().ByName("GreeterService").Methods()
	return &greeterServiceClient{
		sayHello: connect.NewClient[hellopbv1.SayHelloRequest, hellopbv1.SayHelloResponse](
			httpClient,
...
type greeterServiceClient struct {
	sayHello *connect.Client[hellopbv1.SayHelloRequest, hellopbv1.SayHelloResponse]
}

// SayHello calls hello.v1.GreeterService.SayHello.
func (c *greeterServiceClient) SayHello(ctx context.Context, req *connect.Request[hellopbv1.SayHelloRequest]) (*connect.Response[hellopbv1.SayHelloResponse], error) {
...
func (UnimplementedGreeterServiceHandler) SayHello(context.Context, *connect.Request[hellopbv1.SayHelloRequest]) (*connect.Response[hellopbv1.SayHelloResponse], error) {
