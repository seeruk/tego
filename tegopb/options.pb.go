...
type GoType_builder struct {
	...
	// - func(*protoType) (*customType, error)
	// from_proto may be omitted when the protobuf Go type is convertible to the custom Go type. In
	// that case Tego generates a direct Go conversion for this direction.
	FromProto *string
	...
	// - func(*customType) (*protoType, error)
	// to_proto may be omitted when the custom Go type is convertible to the protobuf Go type. When a
	// conversion function is supplied, Tego always uses it even if a direct Go conversion is possible.
	ToProto *string
