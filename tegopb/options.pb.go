...
type GoType_builder struct {
	...
	// - func(*protoType) (*customType, error)
	// from_proto and to_proto may both be omitted when the protobuf and custom Go types are
	// convertible in both directions. In that case Tego generates direct Go conversions.
	FromProto *string
	...
	// - func(*customType) (*protoType, error)
	// When conversion functions are supplied, Tego always uses them even if direct Go conversions
	// would be possible. from_proto and to_proto must either both be supplied or both be omitted.
	ToProto *string
